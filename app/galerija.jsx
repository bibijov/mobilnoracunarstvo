...
import {SafeAreaView, Text, Dimensions, View, TouchableOpacity, Image, StyleSheet} from 'react-native'
...
const galerija = () => {
  ...
  return (
    ...
    />
        {/* <View style={styles.topBox}>
            <TouchableOpacity style={[styles.topButton, {
                ...
                backgroundColor: kojaGalerija==="bgd" ? "#0064b9" : "#383e42"
            }]}
            onPress={()=>setGalerija("bgd")}
            
            >
                <Text style={styles.topText}>Beograd</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.topButton, {
                backgroundColor: kojaGalerija==="srb" ? "#0064b9" : "#383e42"
            }]}
            onPress={()=>setGalerija("srb")}
            >
                <Text style={styles.topText}>Srbija</Text>
            </TouchableOpacity>
        </View> */}
    ...
    <View style={styles.overlay}>
        ...
        <Text style={{color:"white", textAlign:"center", fontSize:20}}>{whatImg.adresa}</Text>
    </View>
    }
    <Navigation/>
    </SafeAreaView>
