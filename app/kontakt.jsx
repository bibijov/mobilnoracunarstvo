      ...
      >
        ...
        <View style={styles.contactBox}>
          ...
          <Text
            ...
            onPress={() => {
              Linking.openURL("https://farbaralanekolor.rs");
            }}
          >
            farbaralanekolor.rs
          </Text>
        ...
        <View style={styles.contactBox}>
          ...
          <Text
            style={styles.kontakt}
            onPress={() => {
              Linking.openURL("tel:0114085781");
            }}
          >
            011 408 5781
          </Text>
        ...
        <View style={styles.contactBox}>
          ...
          <Text
            style={styles.kontakt}
            onPress={() => {
              Linking.openURL("tel:0648012204");
            }}
          >
            064 801 2204
          </Text>
        ...
        <View style={styles.contactBox}>
          ...
          <Text
            style={styles.kontakt}
            onPress={() => {
              Linking.openURL("mailto:lanekolor@gmail.com");
            }}
          >
            lanekolor@gmail.com
          </Text>
        ...
        <View style={styles.contactBox}>
          ...
          <Text
            style={styles.kontakt}
            onPress={() => {
              Linking.openURL("tel:0116305325");
            }}
          >
            011 630 5325
          </Text>
        ...
        <View style={styles.contactBox}>
          ...
          <Text
            style={styles.kontakt}
            onPress={() => {
              Linking.openURL("mailto:lanekolor2@gmail.com");
            }}
          >
        ...
        <View style={styles.contactBox}>
          ...
          <Text
            style={styles.kontakt}
            onPress={() => {
              Linking.openURL("https://lanegradnja.rs");
            }}
          >
            lanegradnja.rs
          </Text>
        ...
        <View style={styles.contactBox}>
          ...
          <Text
            style={styles.kontakt}
            onPress={() => {
              Linking.openURL("tel:0640002940");
            }}
          >
            064 000 2940
          </Text>
