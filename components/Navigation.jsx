...
import {Animated, View, Image, Button, Dimensions, TouchableOpacity, StyleSheet, Text} from 'react-native'
...
const Navigation = () =>{
    ...
    return(
        <View style={styles.navigationBox}>
            <TouchableOpacity style={[styles.navigationSection, styles.navNotLast]}
            onPress={()=>{
                router.push('/')
            }}>
                <FontAwesome name="home" size={30} color="#ea5200" />
            </TouchableOpacity>
            <TouchableOpacity style={[styles.navigationSection, styles.navNotLast]}
            onPress={()=>{
